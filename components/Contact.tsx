      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center w-full">
        <div className="space-y-16 animate-reveal">
          <div className="space-y-6">
            ...
            <h1 className="text-6xl sm:text-8xl font-black text-[#0B1C2D] leading-none">
              Apostolic{' '}
              <span className="italic font-serif text-[#C9A24D]">Inquiry</span>
            </h1>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
            <div className="space-y-4">
              <h4 className="text-[10px] uppercase tracking-[0.4em] font-black text-[#C9A24D]">
                Physical Location
              </h4>
          ...
          <div className="space-y-12 pt-12 border-t border-stone-100">
            <div>
              <h4 className="text-[10px] uppercase tracking-[0.4em] font-black text-[#0B1C2D] mb-6">
                Digital Footprint
              </h4>
              <div className="flex flex-wrap gap-8">
                {[
                  ...
                  >
                    ...
                    <span className="text-[7px] uppercase tracking-[0.3em] font-black text-stone-300 group-hover:text-[#0B1C2D] transition-colors">
                      {social.name}
                    </span>
                  </a>
                ))}
            ...
            <div className="space-y-4">
              <h4 className="text-[10px] uppercase tracking-[0.4em] font-black text-[#0B1C2D]">
                Institutional Partnerships
              </h4>
              <p className="text-stone-400 text-sm font-light leading-relaxed max-w-sm">
                We are open to dialogue with like-minded networks seeking
                doctrinal alignment or curriculum licensing.
              </p>
            </div>
          </div>
        </div>
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="space-y-8 animate-reveal">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div>
                  <label className="block text-[9px] uppercase tracking-widest text-stone-400 font-black mb-3">
                    Name
                  </label>
                  <input
                    type="text"
            ...
            <div className="text-center space-y-8 animate-reveal">
              ...
              <h2 className="text-3xl font-cinzel font-black text-[#0B1C2D]">
                Dispatch Successful
              </h2>
              <p className="text-stone-500 font-light leading-relaxed">
                Your inquiry has been relayed to the Administrative Chancery. A
                representative will provide a response within the appropriate
