      ...
      <div className="max-w-md w-full">
        <div className="bg-white border border-stone-100 p-8 sm:p-12 rounded-3xl shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-cinzel font-black text-[#0B1C2D] mb-2">Governance Login</h2>
            <p className="text-stone-400 text-[10px] uppercase tracking-[0.3em] font-bold">Authorized Personnel Only</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-[9px] uppercase tracking-widest text-stone-500 font-black mb-3 text-center">Enter Institutional Credential</label>
              <input 
                type="password"
                autoFocus
